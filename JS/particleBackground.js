const particle = {
     init: function (e) {
        const t = document.getElementById(e), n = t.getContext("2d"), o = 1;
        let a = t.width = window.innerWidth * o, c = t.height = window.innerHeight * o;
        const i = .05 * a, s = .1 * a, d = (e = 1) => Math.random() * e, l = Math.PI, r = 2 * l; 
        let p = new Date;
        const h = (e, t, n) => (1 - n) * e + n * t, m = (e, t, n, o) => {
            const a = e - n, c = t - o;
        ...
        g = () => {
            p = new Date, y.forEach(e => {
                ...
                (e.y > c || e.y < 0) && (e.angle = -e.angle), d() < .005 && (e.oscAmplitudeX = d(2)),
                d() < .005 && (e.oscSpeedX = .001 + d(.008)), d() < .005 && (e.oscAmplitudeY = d(2)),
                d() < .005 && (e.oscSpeedY = .001 + d(.008)),
                ...
                y.map(e => {
                    y.filter(t => e != t && !(m(e.x, e.y, t.x, t.y) > e.connectDistance)).map(t => {
                        ...
                        return e.speed = h(e.speed, e.speed + .05 / e.connectDistance * n, .2), {
                            ...
                            color: e.color,
                            // color: 255,
                            opacity: Math.floor(100 / e.connectDistance * (e.connectDistance - n)) / 100 } }).forEach((e, t) => {
        ...
        g(), window.addEventListener("mousemove", e => { const t = e.layerX * o, n = e.layerY * o; y.forEach(e => { const o = m(t, n, e.x, e.y); if (o < s && o > 0) { e.angle = ((e, t, n, o) => Math.atan2(o - t, n - e))(t, n, e.x, e.y); const a = .1 * (s - o); e.speed = h(e.speed, a, .2) } }) }), window.addEventListener("resize", e => { a = t.width = window.innerWidth * o, c = t.height = window.innerHeight * o }) } };